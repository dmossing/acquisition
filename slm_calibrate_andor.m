function slm_calibrate_andor(fname)
...
src.set('ExposureTime',0.1) % set exposure time to 100 ms

[height,width] = src.getSize();
vidRes = fliplr([height,width]);
