function natural_movie_playback(moviename, fromTime, toTime, indexisFrames, benchmark, async, preloadSecs, specialflags, pixelFormat)
%
...
% MY CODE: set up DAQ parameters to communicate with acquisition PCs
