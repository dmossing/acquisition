...
Screen('DrawText', wininfo.w, strcat('Filename:',fname,...
...
% STOP ACQUISITION ON SCANBOX !!!
    ...
    function result = pickNext(result,trnum,thiscond)
            ...
            result.gratingInfo.spFreq(trnum) = thiscond(3);
            result.gratingInfo.tFreq(trnum) = thiscond(4);
